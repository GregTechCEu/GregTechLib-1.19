...
import com.gregtechceu.gtlib.gui.animation.Animation;
...
import com.gregtechceu.gtlib.gui.modular.WidgetUIAccess;
...
@Configurable(name = "gtlib.gui.editor.group.basic_info")
public class Widget {

    protected ModularUI gui;
    protected WidgetUIAccess uiAccess;
    @Configurable(tips = "gtlib.gui.editor.tips.id")
    @Setter
    @Getter
    protected String id = "";
    private Position parentPosition = Position.ORIGIN;
    @Configurable(name = "gtlib.gui.editor.name.pos", tips = "gtlib.gui.editor.tips.pos")
    ...
    @Configurable(name = "gtlib.gui.editor.name.hover_tips", tips = "gtlib.gui.editor.tips.hover_tips")
    protected final List<Component> tooltipTexts = new ArrayList<>();
    @Configurable(name = "gtlib.gui.editor.name.background")
    protected IGuiTexture backgroundTexture;
    @Configurable(name = "gtlib.gui.editor.name.hover_texture")
    ...
    public boolean isRemote() {
        return (gui != null && gui.holder != null) ? gui.holder.isRemote() : GTLib.isRemote();
    }
