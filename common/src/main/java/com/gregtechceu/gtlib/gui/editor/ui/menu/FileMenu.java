...
public class FileMenu extends MenuTab {
    ...
    protected TreeBuilder.Menu createMenu() {
        var fileMenu = TreeBuilder.Menu.start()
                .branch("gtlib.gui.editor.menu.new", this::newProject)
                .crossLine()
                .leaf(Icons.OPEN_FILE, "gtlib.gui.editor.menu.open", this::openProject)
                .leaf(Icons.SAVE, "gtlib.gui.editor.menu.save", this::saveProject)
                .crossLine()
                .branch(Icons.IMPORT, "gtlib.gui.editor.menu.import", menu -> {
                    menu.leaf("gtlib.gui.editor.menu.resource", this::importResource);
                })
                .branch(Icons.EXPORT, "gtlib.gui.editor.menu.export", menu -> {
                    menu.leaf("gtlib.gui.editor.menu.resource", this::exportResource);
                });
    ...
    private void exportResource() {
        ...
        if (resources != null) {
            DialogWidget.showFileDialog(editor, "gtlib.gui.editor.tips.save_resource", editor.getWorkSpace(), false,
    ...
    private void importResource() {
        var currentProject = editor.getCurrentProject();
        if (currentProject != null) {
            DialogWidget.showFileDialog(editor, "gtlib.gui.editor.tips.load_resource", editor.getWorkSpace(), true,
                    DialogWidget.suffixFilter(".resource"), r -> {
                        if (r != null && r.isFile()) {
                            try {
    ...
    private void saveProject() {
        ...
        if (project != null) {
            ...
            DialogWidget.showFileDialog(editor, "gtlib.gui.editor.tips.save_project", editor.getWorkSpace(), false,
    ...
    private void openProject() {
        ...
        DialogWidget.showFileDialog(editor, "gtlib.gui.editor.tips.load_project", editor.getWorkSpace(), true,
                node -> {
