...
public class ResourceBorderTexture extends ResourceTexture {
    public static final ResourceBorderTexture BORDERED_BACKGROUND = new ResourceBorderTexture("gtlib:textures/gui/bordered_background.png", 195, 136, 4, 4);
    public static final ResourceBorderTexture BORDERED_BACKGROUND_BLUE = new ResourceBorderTexture("gtlib:textures/gui/bordered_background_blue.png", 195, 136, 4, 4);
    public static final ResourceBorderTexture BUTTON_COMMON = new ResourceBorderTexture("gtlib:textures/gui/button_common.png", 198, 18, 1, 1);
    public static final ResourceBorderTexture BAR = new ResourceBorderTexture("gtlib:textures/gui/button_common.png", 180, 20, 1, 1);

    @Configurable(tips = {"gtlib.gui.editor.tips.corner_size.0", "gtlib.gui.editor.tips.corner_size.1"}, collapse = false)
    public Size boderSize;

    @Configurable(tips = "gtlib.gui.editor.tips.image_size", collapse = false)
    public Size imageSize;

    public ResourceBorderTexture() {
        this("gtlib:textures/gui/bordered_background_blue.png", 195, 136, 4, 4);
    }
