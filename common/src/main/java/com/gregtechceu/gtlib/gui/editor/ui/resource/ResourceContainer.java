...
public class ResourceContainer<T, C extends Widget> extends WidgetGroup {
    ...
    protected TreeBuilder.Menu getMenu() {
        ...
        if (onEdit != null) {
            menu.leaf(Icons.EDIT_FILE, "gtlib.gui.editor.menu.edit", this::editResource);
        }
        menu.leaf("gtlib.gui.editor.menu.rename", this::renameResource);
        menu.crossLine();
        menu.leaf(Icons.COPY, "gtlib.gui.editor.menu.copy", this::copy);
        menu.leaf(Icons.PASTE, "gtlib.gui.editor.menu.paste", this::paste);
        if (onAdd != null) {
            menu.leaf(Icons.ADD_FILE, "gtlib.gui.editor.menu.add_resource", this::addNewResource);
        }
        menu.leaf(Icons.REMOVE_FILE, "gtlib.gui.editor.menu.remove", this::removeSelectedResource);
        return menu;
    }
    ...
    protected void renameResource() {
        if (selected != null) {
            DialogWidget.showStringEditorDialog(Editor.INSTANCE, LocalizationUtils.format("gtlib.gui.editor.tips.rename") + " " + LocalizationUtils.format(resource.name()), selected, s -> {
