 ...
 */
public class Icons {
    public static ResourceTexture LEFT = new ResourceTexture("gtlib:textures/gui/left.png");
    public static ResourceTexture UP = new ResourceTexture("gtlib:textures/gui/up.png");
    public static ResourceTexture DOWN = new ResourceTexture("gtlib:textures/gui/down.png");
    public static ResourceTexture RIGHT = new ResourceTexture("gtlib:textures/gui/right.png");
    ...
    private static ResourceTexture icon(String name) {
        return new ResourceTexture("gtlib:textures/gui/icon/%s.png".formatted(name));
    }
