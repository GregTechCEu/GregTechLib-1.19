package com.gregtechceu.gtlib.networking.s2c;

import com.gregtechceu.gtlib.GTLib;
import com.gregtechceu.gtlib.networking.IHandlerContext;
import com.gregtechceu.gtlib.networking.IPacket;
import com.gregtechceu.gtlib.networking.both.PacketIntLocation;
import com.gregtechceu.gtlib.syncdata.TypedPayloadRegistries;
import com.gregtechceu.gtlib.syncdata.accessor.IManagedAccessor;
...
public class SPacketManagedPayload extends PacketIntLocation implements IPacket {
    ...
    public void processPacket(@NotNull IAutoSyncBlockEntity blockEntity) {
        if (blockEntity.getSelf().getType() != blockEntityType) {
            GTLib.LOGGER.warn("Block entity type mismatch in managed payload packet!");
            return;
        }
