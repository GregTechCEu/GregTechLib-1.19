package com.gregtechceu.gtlib.side.item;
...
public interface IItemTransfer {
     ...
     * </p>
     * Note: This behaviour is subtly different from {@link com.gregtechceu.gtlib.side.fluid.IFluidTransfer#fill(FluidStack, boolean)}
     *
