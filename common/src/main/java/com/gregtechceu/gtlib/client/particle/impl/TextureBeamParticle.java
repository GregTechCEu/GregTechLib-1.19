...
import com.gregtechceu.gtlib.client.particle.BeamParticle;
...
public class TextureBeamParticle extends BeamParticle {
    ...
    public ResourceLocation texture = new ResourceLocation(GTLib.MOD_ID, "textures/particle/laser.png");
